...
- The application filesystem layout structure is based on the [falkonry-tercel] project.
...
## Application Directory Layout
    ...
    app/                --> all of the files to be used in production
      ...
      js/               --> javascript files
        app.js          --> application
        core.js         --> core library and bootstrap functions
      ...
      partials/             --> angular view partials (partial html templates)
        detailView.html     --> the details view
